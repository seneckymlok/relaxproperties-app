...
const statusColors: Record<string, string> = {
    ...
    archived: "bg-[var(--color-surface)] text-[var(--color-secondary)] border border-[var(--color-border)]",
};
            ...
            <div className="bg-white border border-[var(--color-border)] rounded-2xl overflow-hidden shadow-sm">
                {loading ? (
                    ...
                    <div className="p-12 text-center">
                        ...
                        <p className="text-[var(--color-muted)] text-sm">Žiadne články</p>
                        <Link
                            href="/admin/blog/new"
                            className="inline-block mt-3 text-sm text-[var(--color-sand)] hover:underline"
                        >
                            Pridať prvý článok →
                        </Link>
                    </div>
