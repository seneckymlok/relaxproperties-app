                                        ...
                                        {[
                                            {
                                                ...
                                                url: (u: string, title: string) => `https://twitter.com/intent/tweet?url=${encodeURIComponent(u)}&text=${encodeURIComponent(title)}`,
                                            },
                                            {
                                            ...
                                            <button
                                                key={i}
                                                onClick={() => window.open(item.url(typeof window !== 'undefined' ? window.location.href : '', post?.title ?? ''), '_blank', 'noopener,noreferrer,width=600,height=400')}
                                                className="w-9 h-9 flex items-center justify-center rounded-full bg-[var(--color-surface)] text-[var(--color-muted)] hover:bg-[var(--color-primary)] hover:text-white transition-all duration-200"
                                            >
