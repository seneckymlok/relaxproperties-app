...
export default function PropertiesPageContent({ properties }: PropertiesPageContentProps) {
    ...
    return (
        <>
            ...
            {/* Main Content */}
            <section className="py-[clamp(2rem,4vw,4rem)] bg-[var(--color-background)]">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
                        <div className="flex items-center gap-4">
                            ...
                            <button
                                ...
                                className="lg:hidden flex items-center gap-2 px-4 py-2 border border-[var(--color-border)] rounded-lg text-sm font-medium text-[var(--color-foreground)] hover:border-[var(--color-teal)] hover:text-[var(--color-teal)] transition-colors"
                            >
