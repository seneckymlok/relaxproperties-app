                ...
                <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr] gap-[clamp(2rem,4vw,4rem)]">
                    ...
                    <div className="md:max-w-xs text-center md:text-left">
                        ...
                        <div className="space-y-2 mb-6 inline-flex flex-col items-start md:items-start">
                            <a href={`mailto:${emailAddress}`} className="flex items-center gap-2.5 text-white/40 hover:text-white transition-colors duration-200">
                                <svg className="w-3.5 h-3.5 flex-shrink-0 text-[var(--color-accent)]/60" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                                </svg>
                                <span className="text-[13px]">{emailAddress}</span>
                            </a>
                            <a href="tel:+421911819152" className="flex items-center gap-2.5 text-white/40 hover:text-white transition-colors duration-200">
                                <svg className="w-3.5 h-3.5 flex-shrink-0 text-[var(--color-accent)]/60" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
                            ...
                            <a href="tel:+420739049593" className="flex items-center gap-2.5 text-white/40 hover:text-white transition-colors duration-200">
                                <svg className="w-3.5 h-3.5 flex-shrink-0 text-[var(--color-accent)]/60" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
                                </svg>
                        ...
                        <div className="flex flex-col items-center gap-2 md:flex-row md:gap-5">
                            ...
                            <p className="text-[11px] text-white/15 tracking-wide">
                                ...
                                <a
                                    ...
                                    className="nexystech-link text-white/25 hover:text-[var(--color-accent)] transition-colors duration-200"
                                >
                                    NexysTech
                                </a>
                            </p>
